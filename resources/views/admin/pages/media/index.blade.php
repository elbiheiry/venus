    ...
    <div class="page-content">
        <div class="widget">
            <div class="widget-content">
                <form class="row ajax-form" action="{{ route('admin.media.store') }}" method="post">
                    @csrf
                    <div class="col-sm-6">
                        ...
                        <span class="text-danger">Please note that image dimensions should be : 720 * 540
                        </span>
                    </div>
                            ...
                            <table class="table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($images as $index => $image)
                                        <tr>
                                            <td>{{ $x }}</td>
                                            <td><img src="{{ get_image($image->image, 'media') }}" width="100">
                                            </td>
                                            <td>
                                                <button class="custom-btn btn-modal-view"
                                                    data-url="{{ route('admin.media.edit', ['id' => $image->id]) }}">
                                                    <i class="fa fa-edit"></i> Edit
                                                </button>
                                                <button class="custom-btn red-bc delete-btn"
                                                    data-url="{{ route('admin.media.delete', ['id' => $image->id]) }}">
