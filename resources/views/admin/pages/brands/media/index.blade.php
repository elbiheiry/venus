    ...
    <div class="page-content">
        <div class="widget">
            <div class="widget-content">
                <form class="row ajax-form" action="{{ route('admin.brands.media.store', ['id' => $id]) }}"
                    method="post">
                    @csrf
                    <div class="col-sm-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="custom-btn btn-modal-view"
                                                    data-url="{{ route('admin.brands.media.edit', ['id' => $image->id]) }}">
                                                    <i class="fa fa-edit"></i> Edit
                                                </button>
                                                <button class="custom-btn red-bc delete-btn"
                                                    data-url="{{ route('admin.brands.media.delete', ['id' => $image->id]) }}">
