...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="50">
                    <div class="section_title">
                        ...
                        @if($about->translate(app()->getLocale())->description)
    ...
    <section class="section_img">
        <div class="container">
            <div class="row">
                @if($about->translate(app()->getLocale())->mission)
                ...
                @endif
                @if($about->translate(app()->getLocale())->values)
                    <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="50">
                        <div class="text">
                ...
                @endif
                @if($about->translate(app()->getLocale())->vision)
                    <div class="col-md-4 col-sm-12" data-aos="fade-up" data-aos-delay="50">
                        <div class="text">
                            <h3>
