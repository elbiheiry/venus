            ...
            <div class="row">
                    ...
                    <div class="contact_info">
                        ...
                        <div class="contact_item">
                            ...
                            <div class="cont">
                                ...
                                <a href="tel:{{ $brand->phone }}" class="txt_link"> {{ $brand->phone }} </a>
                            </div>
                        </div>
                        ...
                        <div class="contact_item">
                            ...
                            <div class="cont">
                                ...
                                <a href="mailto:{{ $brand->email }}" class="txt_link">
                                    {{ $brand->email }}
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact_form">
                        ...
                        <form class="ajax-form" action="{{ route('site.brand.contact', ['slug' => $brand->slug]) }}"
                            method="post">
                            @csrf
                            @method('post')
